...
export class WeatherRenderer {
     ...
     * 更新云层
     */
    updateClouds(weather, deltaTime) {
        // 根据天气代码决定云量
     ...
     * 创建云
     */
    createCloud(index, rainCloudRatio) {
     ...
     * 更新降水粒子
     */
    updatePrecipitation(weather, deltaTime) {
        const code = weather.weatherCode;
...
//# sourceMappingURL=WeatherRenderer.js.map